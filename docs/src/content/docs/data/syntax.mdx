...
The bare identifier form (`Quit` with no `()`) is **deprecated** as of Moshi v0.3.10. It still works
but emits a warning; write `Quit()` instead. See [issue #22](https://github.com/Roger-luo/Moshi.jl/issues/22)
for the motivation.
